...
class TokenControllerCreateIntegrationTest {
    ...
    void givenValidData_whenCreateToken_thenUserReturned() throws Exception {
        // GIVEN
        userTest = new User("TokenlastName1", "TokenfirstName1", "Tokenemail1@email.email", "TokenPasswordpassword1", null, null, null);
        sellerTest = new Seller("TokenstoreName1",null,null,null);
        customerTest = new Customer("Tokenpseudo1", "TokennumberCityCountry1", null, null, null);
        ...
        // WHEN
        mockMvc.perform(post("/token/create").contentType(MediaType.APPLICATION_JSON).content(jsonUserBeanTest))
        ...
        Assertions.assertEquals(userTest.getFirstName(), resultFromJson.getFirstName());
        Assertions.assertEquals(userTest.getLastName(), resultFromJson.getLastName());
        Assertions.assertEquals(userTest.getCustomerAccount().getAddress(), resultFromJson.getCustomerAccount().getAddress());
        Assertions.assertEquals(userTest.getCustomerAccount().getPseudo(), resultFromJson.getCustomerAccount().getPseudo());
        Assertions.assertEquals(userTest.getSellerAccount().getStoreName(), resultFromJson.getSellerAccount().getStoreName());
    ...
    void givenInvalidData_whenCreateToken_thenInvalidConnexionError() throws Exception {
        ...
        customerTest = new Customer("Tokenpseudo2", "TokennumberCityCountry2", null, null, null);
        userTest.setCustomerAccount(customerTest);
        userTest.setSellerAccount(sellerTest);
    ...
    void givenValidData_whenCheckToken_thenUserReturned() throws Exception {
        // GIVEN
        userTest = new User("TokenlastName3", "TokenfirstName3", "Tokenemail3@email.email", "TokenPasswordpassword3", null, null, null);
        sellerTest = new Seller("TokenstoreName3",null,null,null);
        customerTest = new Customer("Tokenpseudo3", "TokennumberCityCountry3", null, null, null);
        userTest.setCustomerAccount(customerTest);
        userTest.setSellerAccount(sellerTest);
        ...
        // WHEN
        mockMvc.perform(post("/token/check").cookie(cookie))
                .andExpect(status().isOk())
                .andExpect(content().contentType(contentType))
                .andDo(mvcResult -> {
                    jsonResult = mvcResult.getResponse().getContentAsString();
    ...
    void givenInvalidData_whenCheckToken_thenExpiredConnexionError() throws Exception {
        ...
        customerTest = new Customer("Tokenpseudo4", "TokennumberCityCountry4", null, null, null);
        userTest.setCustomerAccount(customerTest);
        userTest.setSellerAccount(sellerTest);
    ...
    void givenValidData_whenRemoveToken_thenSuccess() throws Exception {
        // GIVEN
        userTest = new User("TokenlastName5", "TokenfirstName5", "Tokenemail5@email.email", "TokenPasswordpassword5", null, null, null);
        sellerTest = new Seller("TokenstoreName5",null,null,null);
        customerTest = new Customer("Tokenpseudo5", "TokennumberCityCountry5", null, null, null);
        userTest.setCustomerAccount(customerTest);
        userTest.setSellerAccount(sellerTest);
        ...
        // WHEN
        mockMvc.perform(post("/token/remove").cookie(cookie))
                .andExpect(status().isOk())
                .andExpect(content().contentType(contentType))
                .andDo(mvcResult -> {
                    jsonResult = mvcResult.getResponse().getContentAsString();
    ...
    void givenInvalidData_whenRemoveToken_thenFailure() throws Exception {
        // GIVEN
        userTest = new User("TokenlastName6", "TokenfirstName6", "Tokenemail6@email.email", "TokenPasswordpassword6", null, null, null);
        sellerTest = new Seller("TokenstoreName6",null,null,null);
        customerTest = new Customer("Tokenpseudo6", "TokennumberCityCountry6", null, null, null);
        userTest.setCustomerAccount(customerTest);
        userTest.setSellerAccount(sellerTest);
